...
<script type="text/javascript" src="<%=path %>/admin/js/admin_login.js"></script>
<!--[if IE 6]>
    ...
    <form class="form form-horizontal"  method="post" onsubmit="return check();">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="account" name="admin.account" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="password" name="admin.password" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright 中餐厅 by H-ui.admin v3.1</div>
