...
public class CategoryDAO extends BaseHibernateDAO  {
    ...
    public Category findById( java.lang.Integer id) {
        ...
        try {
            Category instance = (Category) getSession()
                    .get("com.canteen.pojo.Category", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Category> findByExample(Category instance) {
        ...
        try {
            List<Category> results = (List<Category>) getSession()
                    .createCriteria("com.canteen.pojo.Category")
                    .add( create(instance) )
            .list();
    ...
    public void updateCategpory(String name,Integer id){
